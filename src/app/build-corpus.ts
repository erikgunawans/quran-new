...
//
// So: rank divergence, hand it to the human, and let the human rule. See data/review/.
...
await Bun.write("data/review/divergence.json", JSON.stringify({ threshold: DIVERGENCE_THRESHOLD, count: review.length, verses: review }, null, 2));
...
console.log(`✓ review   ${diverging} verses ranked for human review → data/review/divergence.json (NOT shipped)`);
