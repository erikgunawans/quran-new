...
- [ ] ISC-525: ISA `progress:` is RECOMPUTED across all three checkbox markers, never hand-set.
- [ ] ISC-526: the work is committed and pushed to `origin/main`.
